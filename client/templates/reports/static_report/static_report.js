...
//     dparams = SubjectParameters.findOne({'envId': envId});
//     sparams = SequenceParameters.findOne({'envId': envId});
//
//     $(".obs-selection").empty();
...
//
//   let sequence_params = SequenceParameters.findOne({envId:envId});
...
//             // consol
//             if (param.label !== demp) continue;  // todo: this really needs to be refactored.
//
//             let listedParams = param.options
...
//         var sortedData = [];
//
//         let sequenceParameters = SequenceParameters.findOne({envId:envId});
//
