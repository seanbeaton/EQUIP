...
Meteor.methods({
  ...
  observationModify: function (obj) {
    console.log('observationModify', 'before access check');
    checkAccess(obj.obsId, 'observation', 'edit');
    console.log('observationModify', 'after access check');
    console.log('observationModify', 'before update');
    Observations.update({'_id': obj.obsId}, {$set: {'lastModified': new Date()}});
    console.log('observationModify', 'after update');
