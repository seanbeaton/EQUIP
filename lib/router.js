...
Router.route('/dashboard', {
  ...
  waitOn: function() {
    return [
      ...
      // Meteor.subscribe('ownObservations'),
      // Meteor.subscribe('ownSubjects'),
      // Meteor.subscribe('ownSequences'),
      // Meteor.subscribe('ownSubjectParameters'),
      // Meteor.subscribe('ownSequenceParameters'),
    ]
  }
});
...
Router.route('/editSubjectParameters/:_envId', {
  ...
  waitOn: function() {
    return [
      ...
      Meteor.subscribe('groupEnvObservations', this.params._envId),
...
// Router.route('/reports/interactive/view/:_obsId', {
//   name: 'interactiveReportView',
//   data: function() {
...
Router.route('/environment/:_envId', {
  ...
  waitOn: function () {
    return [
      ...
      Meteor.subscribe('envSequences', this.params._envId),
      Meteor.subscribe('envSubjectParameters', this.params._envId),
      Meteor.subscribe('envSequenceParameters', this.params._envId),
      ...
      Meteor.subscribe('groupEnvSequences', this.params._envId),
      Meteor.subscribe('groupEnvSubjectParameters', this.params._envId),
      Meteor.subscribe('groupEnvSequenceParameters', this.params._envId),
    ]
  }
...
Router.route('/environment/:_envId/subjects-advanced', {
  ...
  data: function() { return {environment: Environments.findOne(this.params._envId)}; }
});
...
Router.route('/environment/:_envId/observatory/:_obsId', {
  ...
  data: function() {
    return {
      observation: Observations.findOne(this.params._obsId),
      environment: Environments.findOne(this.params._envId)
    }
  }
});
